-- Era ped whitelist for Los Animales RP.
-- Grouped lists correspond to ambient, scenario, and special-case NPC pools.
return {
    groups = {
        ambient_females = {
    ...
    allow = {
        's_m_m_postal_02','s_m_m_gardener_01','s_m_m_dockwork_01','s_m_m_linecook',
        's_m_m_autoshop_02','s_m_m_pilot_01','s_m_y_cop_01','s_f_y_cop_01',
        's_m_y_hwaycop_01','s_m_y_fireman_01','s_m_m_paramedic_01','ig_bankman',
        'ig_barry','ig_business_01','ig_tenniscoach','ig_tourist_01','ig_vagos_leader',
        'ig_fbisuit_01','a_m_m_bevhills_02','a_f_m_bevhills_02','a_m_y_genstreet_01',
        'a_f_y_genstreet_01','csb_reporter','ig_josef','ig_clay','ig_lestercrest',
        'a_m_m_skidrow_01','u_m_m_jesus_01','u_m_y_imporage','u_m_y_zombie_01',
        'ig_orleans','ig_rustyfox','ig_della_alley','ig_berry_mason','ig_sid_light',
        'ig_crimson_bat','ig_hops_montalvo','ig_gertie_lark','u_m_y_abner','u_m_y_sasquatch',
        'u_m_m_spacegoon_01','u_m_y_juggernaut_01','ig_alien_pilot','ig_void_sentinel',
        'u_m_m_bikehire_01','u_m_m_streetart_01','u_m_m_prolsec_01','ig_admin_char',
        'ig_event_host'
    },
    prefixes = {
        'la:toontown:',
